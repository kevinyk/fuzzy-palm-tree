...
var ApiService = (function () {
    ...
    ApiService.prototype.addNote = function (aNote) {
        return this._http.post('/api/notes', aNote).map(function (Response) { return Response.json(); }).toPromise();
    };
    ApiService.prototype.getNotes = function () {
        return this._http.get('/api/notes').map(function (Response) { return Response.json(); }).toPromise();
    };
    return ApiService;
}());
...
module.exports = "<app-notes></app-notes>"
...
module.exports = "<h2>Notes</h2>\n<h3>Add a new note:</h3>\n<form (submit)=\"onSubmit()\">\n\t<p>Title: <input type=\"text\" name=\"title\" [(ngModel)]=\"newNote.title\" #title=\"ngModel\"></p>\n\t<p>Content: <input type=\"text\" name=\"content\" [(ngModel)]=\"newNote.content\" #content=\"ngModel\"></p>\n\t<input type=\"submit\" name=\"\">\n</form>\n\n<fieldset *ngFor=\"let note of notes\">\n\t<h2>{{note.title}}</h2>\n\t<p>{{note.content}}</p>\n</fieldset>"
...
var NotesComponent = (function () {
    function NotesComponent(_apiService) {
